...
"""
***子进程运行会拷贝主进程的资源，所有这里也要关闭一次(子进程用到对象，都要关闭，或者删除一次)
"""
...
class WebServer(object):
    ...
    def init_projects(self):
        ...
        # 3.更改web服务器打开的文件目录，根据字典的key得到项目的路径
    ...
    def start(self):
        ...
        while True:
            ...
            #***创建进程对象***
            p1 = multiprocessing.Process(target=self.request_headler, args=(new_client_so, ip_port))
            #启动线程
            p1.start()
            # ***子进程运行会拷贝主进程的资源，所有这里也要关闭一次(子进程用到对象，都要关闭，或者删除一次)
            new_client_so.close()
